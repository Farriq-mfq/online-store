        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            <label for="stock" required>Stock</label>
                            <input type="number" min="0" class="form-control <?= show_class_error("stock") ?>" name="stock" id="stock" value="<?= set_value("stock") ? set_value("stock") : $product->stock ?>">
                            <?= show_error("stock") ?>
                        </div>
                        <div class="form-group">
                            <label for="sku" required>SKU</label>
                            <input type="text" class="form-control <?= show_class_error("sku") ?>" name="sku" id="sku" value="<?= set_value("sku") ? set_value("sku") : $product->sku ?>">
                            <?= show_error("sku") ?>
                        </div>
                        <div class="form-group">
