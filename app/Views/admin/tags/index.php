                    ...
                    <tbody>
                        <?php foreach ($tags as $tag) : ?>
                            <tr>
                                <td><?= $tag->tag; ?></td>
                                <td>
                                    <button class="btn btn-sm btn-primary" id="btn_show_modal_edit_tags" type="button" data-id="<?= $tag->tag_id ?>">
                                        <i class="fas fa-edit"></i>
                                    </button>
                                    <button class="btn btn-danger btn-sm" confirm data-slug="<?= $tag->tag ?>" data-action="<?= admin_url("/tags/" . esc($tag->tag_id)) ?>"><i class="fas fa-trash"></i></button>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
