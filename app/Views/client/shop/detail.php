		...
		<div class="row s_product_inner">
			...
			<div class="col-lg-5 offset-lg-1">
				<div class="s_product_text">
					<h3><?= $product->title ?></h3>
					<?php if ($product->product_inventories) : ?>
						<h2><?= getMinMax($product->price, $product->product_inventories) ?></h2>
					<?php else : ?>
						<h2><?= $product->price ?></h2>
					<?php endif ?>
					<ul class="list">
						<li><a class="active" href="#"><span>Category</span> : <?= $product->category->category ?></a></li>
						<li><a href="#"><span>Availibility</span> : <?= $availible_stock > 0 ? "In Stock" : "Out Of Stock" ?>&nbsp;(<?= $availible_stock ?>)</a></li>
					</ul>
					<p><?= $product->short_description ?></p>
					<?php if ($product->product_inventories) : ?>
						<h6>VARIANT</h6>
						<div class="d-flex flex-wrap mb-3" style="gap: 10px;">
							<?php foreach ($product->product_inventories as $prd) : ?>
								<label class="d-flex align-items-center justify-content-between border" style="padding: 0.5rem;border-radius: 5px;">
									<div class="primary-radio">
										<input type="radio" id="<?= "default-radio" . $prd->inventory_id ?>" name="inventory_id" value="<?= $prd->inventory_id ?>">
										<label for="<?= "default-radio" . $prd->inventory_id ?>"></label>
									</div>
									<span class="ml-2"><?= strtoupper($prd->color) ?>&nbsp;(<?= $prd->stock ?>)</span>
								</label>
							<?php endforeach ?>
						</div>
					<?php endif ?>
					...
					<div class="card_area d-flex align-items-center">
						<button class="btn primary-btn" type="button" id="add_cart_btn">Add to Cart</button>
					</div>
				</div>
			</div>
		</div>
...
<section class="product_description_area">
	<div class="container">
		<ul class="nav nav-tabs" id="myTab" role="tablist">
			...
			<li class="nav-item">
				<a class="nav-link" id="content-tab" data-toggle="tab" href="#content" role="tab" aria-controls="content" aria-selected="false">Specification</a>
			</li>
			<li class="nav-item">
